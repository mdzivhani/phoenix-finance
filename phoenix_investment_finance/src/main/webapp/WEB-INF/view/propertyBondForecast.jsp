...
<%
	...
	request.getSession().setAttribute("bondForecast", bondForecast);
%>
<div class="container">
	<div class="row text-center">
		<h3>Property Bond Forecast</h3>
	</div>
	<div class="row">
		<div class="col-md-4">
			<form action="../bondForecast/forecast">
				<div class="form-group table-responsive nomargin nopadding">
					...
					<input type="hidden" name="baseTerm"
						value="<%=bondForecast.getBond().getTerm()%>"> <input
						type="hidden" name="baseBondFund"
						value="<%=bondForecast.getBond().getBondFund().getBank()%>"> <input
						type="hidden" name="baseBondType"
						value="<%=bondForecast.getBond().getBondType()%>">
				</div>
			...
			<div class="col-md-5">
				<form method="get" action="../addToInvestments.jsp">
					<button type="submit" value="Registered Client"
						class="btn btn-default">Registered Client</button>
				</form>
			</div>
		</div>
			...
			<div class="col-md-6">
				...
				<table class="table table-bordered table-striped">
					<tbody>
						...
						<tr>
							<td class="money"><b>Property Bond Type</b></td>
							<td class="money"><%=bondForecast.getBond().getBondType()%></td>
						</tr>
						<tr>
							<td class="money"><b>Bond Fund</b></td>
							<td class="money"><%=bondForecast.getBond().getBondFund().getBank()%></td>
						</tr>
					</tbody>
				</table>
			</div>
